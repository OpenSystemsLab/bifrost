...
// ConvertEmbeddingRequestToVertex converts a Bifrost embedding request to Vertex AI format
func ConvertEmbeddingRequestToVertex(bifrostReq *schemas.BifrostRequest) *VertexEmbeddingRequest {
...
// ConvertVertexEmbeddingResponseToBifrost converts a Vertex AI embedding response to Bifrost format
func ConvertVertexEmbeddingResponseToBifrost(vertexResp *VertexEmbeddingResponse, model string, params *schemas.ModelParameters) *schemas.BifrostResponse {
